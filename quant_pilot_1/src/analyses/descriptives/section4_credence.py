...
of section_4_credence_in_correct_answer.
"""
...
def main():
    ...
    COL = "section_4_credence_in_correct_answer"
    s = df[COL].dropna()
    ...
    txt = OUT / "section4_credence_descriptives.txt"
    ...
    ax.set_xlabel("Section 4 Credence in Correct Answer")
    ax.set_ylabel("Count")
    ax.set_title("Section 4 Credence in Correct Answer")
    ax.legend()
    plt.tight_layout()
    fig.savefig(OUT / "section4_credence_histogram.png", dpi=150)
    print(f"Saved section4_credence_histogram.png")
    plt.close()
    ...
    ax.set_ylabel("Section 4 Credence in Correct Answer")
    ax.set_title("Section 4 Credence in Correct Answer by Debate Question")
    plt.xticks(rotation=45, ha="right")
    plt.tight_layout()
    fig.savefig(OUT / "section4_credence_by_debate_swarmplot.png", dpi=150)
    print(f"Saved section4_credence_by_debate_swarmplot.png")
    plt.close()
