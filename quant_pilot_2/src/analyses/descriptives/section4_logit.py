...
logit_section_4_credence_in_correct_answer differs from 0.
"""
...
def main():
    ...
    txt = OUT / "section4_logit_descriptives.txt"
    ...
    ax.set_xlabel("Logit Section 4 Credence in Correct Answer")
    ax.set_ylabel("Count")
    ax.set_title("Logit Section 4 Credence in Correct Answer")
    ax.legend()
    plt.tight_layout()
    fig.savefig(OUT / "section4_logit_histogram.png", dpi=150)
    print(f"Saved section4_logit_histogram.png")
    plt.close()
    ...
    ax.set_ylabel("Logit Section 4 Credence in Correct Answer")
    ax.set_title("Logit Section 4 Credence by Debate Question")
    ax.legend(title="Debate (within question)", loc="best")
    plt.xticks(rotation=45, ha="right")
    plt.tight_layout()
    fig.savefig(OUT / "section4_logit_by_debate_swarmplot.png", dpi=150)
    print(f"Saved section4_logit_by_debate_swarmplot.png")
    plt.close()
