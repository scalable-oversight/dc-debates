...
(`data/cleaned/quant-1-official-study.xlsx`) was withheld because it retains
`PROLIFIC_PID` and self-reported demographics. The de-identified output this
script produces is shipped directly at
`data/cleaned/quant-1-official-study-noids.xlsx`. See
